...
export class SmtpValidationService {
   ...
   */
  static async validateSmtpCredentials(settings: SmtpSettings): Promise<ValidationResult> {
    try {
      // Input validation
   ...
   */
  static async testSmtpWithEmail(settings: SmtpSettings, testEmail: string): Promise<ValidationResult> {
    try {
      // First validate the connection
      const connectionResult = await this.validateSmtpCredentials(settings);
